      ...
      <Dialog open={userOpen} onOpenChange={setUserOpen}>
        <DialogContent className="max-h-[92vh] max-w-2xl overflow-y-auto">
          ...
          <form onSubmit={submitUser} className="space-y-4">
            ...
            <div className="space-y-2"><Label htmlFor="password">Temporary password</Label><Input id="password" name="password" type="text" required placeholder="Min 12 characters" /></div>
