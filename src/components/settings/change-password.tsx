...
export function ChangePassword() {
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="text-lg"><KeyRound className="mr-2 inline h-4 w-4" />Password</CardTitle><CardDescription>Minimum 12 characters.</CardDescription></CardHeader>
      <CardContent>
