...
_Last updated: 21 July 2026 · current build v12.0_
...
| # | What | Why it matters |
|---|---|---|
| 1 | **Deploy v12.0** — run `MIGRATION_v12.0_all.sql` in Neon, sync `ameya-heights-crm-v12.0.zip`, Create Deployment | Expense import, UTR tracking, receipts and AI health are all waiting |
